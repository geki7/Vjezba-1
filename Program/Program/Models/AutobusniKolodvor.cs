...
namespace Program.Models
{
    public class AutobusniKolodvor
    {
        ...
        public AutobusniKolodvor()
        {
            ...
            this.linije.Add(new Linija("Varazdin", "Slabonski Brod", 240));
        ...
        public string KupiKartu(string polaziste, string odrediste, string tipKarte)
        {
            ...
            return "Cijena za kratu tipa " + tipKarte + ", na relaciji " + polaziste + " - " + odrediste + " iznosi: " + IzracunajCijenu(udaljenost, tipKarte);
        }
    }
}
